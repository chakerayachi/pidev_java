 ...
 * @author chaker
 */
public class ModifierPasswordClientFXMLController implements Initializable {
    ...
    public void changerPass(){
        ...
        try {
            ...
            Logger.getLogger(ModifierPasswordClientFXMLController.class.getName()).log(Level.SEVERE, null, ex);
        }
