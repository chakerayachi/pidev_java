...
public class AjouterRéservationChambreController implements Initializable { 
    ...
    public void initialize(URL url, ResourceBundle rb) {
        hotel_name.setText(hotel.getLibelle());
        total_fied.setText("");
        ...
        service_chambre.get_chambre_by_hotel_id(hotel.getId()).forEach((p)->{
...
Callback<DatePicker, DateCell> call_date_debut = new Callback<DatePicker, DateCell>() {
    ...
    private void create_reservation(ActionEvent event) {
         ...
         if(check_from_filled()){  
            ...
            Reservation reservation=new Reservation(date_deb,date_fn,total,0,0,0,id_chambre,Utilisateur.user_connecter.getId(),0,"hotel"); 
