 ...
 * @author alaaz
 */
public class StatistiquesRéservationsEvenementsController implements Initializable {
 ...
 ServiceRéservationIMP service_reservation=new ServiceRéservationIMP();
    ...
    public void initialize(URL url, ResourceBundle rb) { 
     ...
     private BarChart buildBarChart() { 
        ...
        service_reservation.get_statistics_incomes_evenements().forEach((p)->{
      ...
      private BarChart buildBarChartGainsEstimationbyDate_annualy() { 
        ...
        dataSeries1.getData().add(new XYChart.Data(last_year, service_reservation.get_statistics_incomes_annualy_evenements(last_year)));
        dataSeries1.getData().add(new XYChart.Data(this_year, service_reservation.get_statistics_incomes_annualy_evenements(this_year)));
        barChart.getData().add(dataSeries1);
        barChart.setId("bar_chart");
      ...
      private LineChart buildLineChartIncomesMonthly(){ 
            ...
            series.getData().add(new XYChart.Data("Jan", service_reservation.get_statistics_incomes_monthly_evenements("01",this_year)));
            series.getData().add(new XYChart.Data("Feb",  service_reservation.get_statistics_incomes_monthly_evenements("02",this_year)));
            series.getData().add(new XYChart.Data("Mar",  service_reservation.get_statistics_incomes_monthly_evenements("03",this_year)));
            series.getData().add(new XYChart.Data("Apr",  service_reservation.get_statistics_incomes_monthly_evenements("04",this_year)));
            series.getData().add(new XYChart.Data("May",  service_reservation.get_statistics_incomes_monthly_evenements("05",this_year)));
            series.getData().add(new XYChart.Data("Jun",  service_reservation.get_statistics_incomes_monthly_evenements("06",this_year)));
            series.getData().add(new XYChart.Data("Jul",  service_reservation.get_statistics_incomes_monthly_evenements("07",this_year)));
            series.getData().add(new XYChart.Data("Aug",  service_reservation.get_statistics_incomes_monthly_evenements("08",this_year)));
            series.getData().add(new XYChart.Data("Sep",  service_reservation.get_statistics_incomes_monthly_evenements("09",this_year)));
            series.getData().add(new XYChart.Data("Oct",  service_reservation.get_statistics_incomes_monthly_evenements("10",this_year)));
            series.getData().add(new XYChart.Data("Nov",  service_reservation.get_statistics_incomes_monthly_evenements("11",this_year)));
            series.getData().add(new XYChart.Data("Dec",  service_reservation.get_statistics_incomes_monthly_evenements("12",this_year)));
     ...
     private PieChart buildPieChart() {
        ...
        service_reservation.get_statistics_nb_reservations_evenements().forEach((p)->{
