 ...
 * @author alaaz
 */
public class StatistiquesRéservationsHotelsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) { 
     ...
     private BarChart buildBarChart() { 
        ...
        service_reservation.get_statistics_incomes_hotels().forEach((p)->{
      ...
      private BarChart buildBarChartGainsEstimationbyDate_annualy() { 
        ...
        dataSeries1.getData().add(new XYChart.Data(last_year, service_reservation.get_statistics_incomes_annualy_hotels(last_year)));
        dataSeries1.getData().add(new XYChart.Data(this_year, service_reservation.get_statistics_incomes_annualy_hotels(this_year)));
        barChart.getData().add(dataSeries1);
        barChart.setId("bar_chart");
      ...
      private LineChart buildLineChartIncomesMonthly(){ 
            ...
            series.getData().add(new XYChart.Data("Jan", service_reservation.get_statistics_incomes_monthly_hotels("01",this_year)));
            series.getData().add(new XYChart.Data("Feb",  service_reservation.get_statistics_incomes_monthly_hotels("02",this_year)));
            series.getData().add(new XYChart.Data("Mar",  service_reservation.get_statistics_incomes_monthly_hotels("03",this_year)));
            series.getData().add(new XYChart.Data("Apr",  service_reservation.get_statistics_incomes_monthly_hotels("04",this_year)));
            series.getData().add(new XYChart.Data("May",  service_reservation.get_statistics_incomes_monthly_hotels("05",this_year)));
            series.getData().add(new XYChart.Data("Jun",  service_reservation.get_statistics_incomes_monthly_hotels("06",this_year)));
            series.getData().add(new XYChart.Data("Jul",  service_reservation.get_statistics_incomes_monthly_hotels("07",this_year)));
            series.getData().add(new XYChart.Data("Aug",  service_reservation.get_statistics_incomes_monthly_hotels("08",this_year)));
            series.getData().add(new XYChart.Data("Sep",  service_reservation.get_statistics_incomes_monthly_hotels("09",this_year)));
            series.getData().add(new XYChart.Data("Oct",  service_reservation.get_statistics_incomes_monthly_hotels("10",this_year)));
            series.getData().add(new XYChart.Data("Nov",  service_reservation.get_statistics_incomes_monthly_hotels("11",this_year)));
            series.getData().add(new XYChart.Data("Dec",  service_reservation.get_statistics_incomes_monthly_hotels("12",this_year)));
     ...
     private PieChart buildPieChart() {
        ...
        service_reservation.get_statistics_nb_reservations_hotels().forEach((p)->{
